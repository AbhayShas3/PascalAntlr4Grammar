...
public interface PascalVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PascalParser#classDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassDeclaration(PascalParser.ClassDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#classBlock}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassBlock(PascalParser.ClassBlockContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#visibilitySection}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVisibilitySection(PascalParser.VisibilitySectionContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#classField}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassField(PascalParser.ClassFieldContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#classMethod}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassMethod(PascalParser.ClassMethodContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#methodDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMethodDeclaration(PascalParser.MethodDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#constructorDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitConstructorDeclaration(PascalParser.ConstructorDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#destructorDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDestructorDeclaration(PascalParser.DestructorDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#className}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassName(PascalParser.ClassNameContext ctx);
	/**
	 * Visit a parse tree produced by {@link PascalParser#objectInstantiation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitObjectInstantiation(PascalParser.ObjectInstantiationContext ctx);
	/**
