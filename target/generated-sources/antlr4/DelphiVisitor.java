...
public interface DelphiVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DelphiParser#className}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	 ...
	 * @return the visitor result
	 */
	T visitBaseClassName(DelphiParser.BaseClassNameContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link DelphiParser#classMethodDeclaration}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassMethodDeclaration(DelphiParser.ClassMethodDeclarationContext ctx);
	/**
	 * Visit a parse tree produced by {@link DelphiParser#classMethodImplementation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassMethodImplementation(DelphiParser.ClassMethodImplementationContext ctx);
	/**
